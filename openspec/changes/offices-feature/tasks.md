...
| TASK-06 | OfficesServiceProvider bindings + registration | Infrastructure | `app/Providers/OfficesServiceProvider.php`, `bootstrap/providers.php` | ~18 | ✅ |
...
| TASK-14 | Unit tests (Office entity + repository mapper) | Tests (Unit) | `tests/Unit/Domain/Offices/OfficeEntityTest.php`, `tests/Unit/Infrastructure/Offices/EloquentOfficeRepositoryMapperTest.php` | ~40 | ✅ |
